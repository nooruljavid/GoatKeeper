...
data class Country(
    val name: String,
    val code: String,
    val postalCodeLabel: String = "Postal Code",
...
val countries = listOf(
    ...
    Country("South Africa", "+27", "Postal Code", "R"),
    Country("Nigeria", "+234", "Postal Code", "₦"),
    Country("Kenya", "+254", "Postal Code", "KSh"),
    Country("Pakistan", "+92", "Postal Code", "₨"),
    Country("Bangladesh", "+880", "Postal Code", "৳"),
    Country("Sri Lanka", "+94", "Postal Code", "Rs"),
    // Arab Countries
    Country("Algeria", "+213", currencySymbol = "DA"),
    Country("Bahrain", "+973", currencySymbol = "BD"),
    Country("Comoros", "+269", currencySymbol = "CF"),
    Country("Djibouti", "+253", currencySymbol = "Fdj"),
    Country("Egypt", "+20", currencySymbol = "E£"),
    Country("Iraq", "+964", currencySymbol = "ID"),
    Country("Jordan", "+962", currencySymbol = "JD"),
    Country("Kuwait", "+965", currencySymbol = "KD"),
    Country("Lebanon", "+961", currencySymbol = "L£"),
    Country("Libya", "+218", currencySymbol = "LD"),
    Country("Mauritania", "+222", currencySymbol = "UM"),
    Country("Morocco", "+212", currencySymbol = "DH"),
    Country("Oman", "+968", currencySymbol = "RO"),
    Country("Palestine", "+970", currencySymbol = "₪"),
    Country("Qatar", "+974", currencySymbol = "QR"),
    Country("Saudi Arabia", "+966", currencySymbol = "SR"),
    Country("Somalia", "+252", currencySymbol = "Ssh"),
    Country("Sudan", "+249", currencySymbol = "SD"),
    Country("Syria", "+963", currencySymbol = "S£"),
    Country("Tunisia", "+216", currencySymbol = "DT"),
    Country("United Arab Emirates", "+971", currencySymbol = "DH"),
    Country("Yemen", "+967", currencySymbol = "YR"),
    // EU Countries (Euro)
    Country("Austria", "+43", currencySymbol = "€"),
    Country("Belgium", "+32", currencySymbol = "€"),
    Country("Bulgaria", "+359", currencySymbol = "лв"),
    Country("Croatia", "+385", currencySymbol = "€"),
    Country("Cyprus", "+357", currencySymbol = "€"),
    Country("Czech Republic", "+420", currencySymbol = "Kč"),
    Country("Denmark", "+45", currencySymbol = "kr"),
    Country("Estonia", "+372", currencySymbol = "€"),
    Country("Finland", "+358", currencySymbol = "€"),
    Country("France", "+33", currencySymbol = "€"),
    Country("Germany", "+49", currencySymbol = "€"),
    Country("Greece", "+30", currencySymbol = "€"),
    Country("Hungary", "+36", currencySymbol = "Ft"),
    Country("Ireland", "+353", "Eircode", "€"),
    Country("Italy", "+39", currencySymbol = "€"),
    Country("Latvia", "+371", currencySymbol = "€"),
    Country("Lithuania", "+370", currencySymbol = "€"),
    Country("Luxembourg", "+352", currencySymbol = "€"),
    Country("Malta", "+356", currencySymbol = "€"),
    Country("Netherlands", "+31", currencySymbol = "€"),
    Country("Poland", "+48", currencySymbol = "zł"),
    Country("Portugal", "+351", currencySymbol = "€"),
    Country("Romania", "+40", currencySymbol = "lei"),
    Country("Slovakia", "+421", currencySymbol = "€"),
    Country("Slovenia", "+386", currencySymbol = "€"),
    Country("Spain", "+34", currencySymbol = "€"),
    Country("Sweden", "+46", currencySymbol = "kr")
).sortedBy { it.name }
